...
<link rel="stylesheet" type="text/css"
    href="{{ asset('/public/pp-assets/vendors/css/extensions/datedropper.min.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{ asset('/public/pp-assets/vendors/css/extensions/timedropper.min.css') }}">
<style>
...
@endsection
@section('scripts')
<script src="{{ asset('/public/pp-assets/vendors/js/ui/jquery.sticky.js') }}"></script>
<script src="{{ asset('/public/pp-assets/vendors/js/extensions/datedropper.min.js') }}"></script>
<script src="{{ asset('/public/pp-assets/vendors/js/extensions/timedropper.min.js') }}"></script>
<script src="{{ asset('/public/pp-assets/js/scripts/extensions/date-time-dropper.min.js') }}"></script>
<script src="{{ asset('/public/pp-assets/js/scripts/forms/custom-file-input.min.js') }}"></script>
@endsection