<link rel="apple-touch-icon" href="{{ asset('/public/assets/rmz-logos/icon.png') }}">
<link rel="shortcut icon" type="image/x-icon"
    href="{{ asset('/public/assets/rmz-logos/rmz.ico') }}">
<link
...
<link rel="stylesheet" type="text/css" href="{{ asset('/public/app-assets/vendors/css/charts/chartist-plugin-tooltip.css') }}">
<!-- END: Vendor CSS-->
